  ...
  return (
    <div className="login-page-container">
      ...
      <div className="login-page-form-container">
        ...
        />
        <Button onClick={login} className="login-page-submit-button" variant="contained">
          Sign in
        </Button>
        <h4 className="login-page-signup-prompt">
          Don't have an account?{" "}
          <span onClick={() => navigate("/signup")} className="login-page-signup-prompt-link">Register</span>
        </h4>
      </div>
    </div>
  );
